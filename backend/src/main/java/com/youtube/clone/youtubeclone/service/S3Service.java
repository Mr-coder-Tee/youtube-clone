...
public class S3Service implements FileService{
    ...
    public static final String BUCKETNAME = "youtube-clone-terrence";
    ...
    public String uploadFile(MultipartFile file){
        ...
        try {
            ...
            throw new ResponseStatusException(HttpStatus.INTERNAL_SERVER_ERROR,"Exception occured while uploading the file");
        }
